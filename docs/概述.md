...
SCF CLI是腾讯云无服务器云函数（Serverless Cloud Function，SCF）产品的命令行工具。通过 scf 命令行工具，您可以方便的实现函数打包、部署、本地调试，也可以方便的生成云函数的项目并基于 demo 项目进一步的开发。
...
scf cli可以在 Windows、Linux、Mac 上运行。scf cli基于 Python 开发完成，因此在安装及运行前需要系统中安装有 Python 环境。更多详细信息可参见 [安装与配置](https://cloud.tencent.com/document/product/583/33449)。
